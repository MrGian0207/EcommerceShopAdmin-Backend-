...
slideRouter.post('/slides/add', authenToken_1.default, multer_1.default.single('slide-image'), slideController.store);
...
slideRouter.post('/slides/:id', authenToken_1.default, multer_1.default.single('slide-image'), slideController.update);
