...
mainCategoriesRouter.post('/categories/main-categories/add', authenToken_1.default, multer_1.default.single('category-image'), mainCategoriesController.store);
...
mainCategoriesRouter.post('/categories/main-categories/:id', authenToken_1.default, multer_1.default.single('category-image'), mainCategoriesController.update);
