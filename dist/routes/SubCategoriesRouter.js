...
subCategoriesRouter.post('/categories/sub-categories/add', authenToken_1.default, multer_1.default.single('sub-category-image'), subCategoriesController.store);
...
subCategoriesRouter.post('/categories/sub-categories/:id', authenToken_1.default, multer_1.default.single('sub-category-image'), subCategoriesController.update);
